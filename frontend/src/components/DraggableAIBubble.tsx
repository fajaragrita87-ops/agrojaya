...
const AGROJAYA_KNOWLEDGE = {
  kebun: {
    ...
    luas: '2.0 Hektar',
    blok: ['Blok A1 (Cabai Merah, 0.5 Ha)', 'Blok A2 (Cabai Keriting, 0.5 Ha)', 'Blok B1 (Tomat Beef, 1.0 Ha)'],
    statusTanah: 'pH 6.2 (Normal), Nitrogen Rendah, Fosfor Cukup, Kalium Baik',
    cuaca: 'Prediksi hujan sore ini. Suhu rata-rata 28°C.',
  },
  keuangan: {
    modalInvestasi: 'Rp 850.000.000',
    opexBulanIni: 'Rp 45.000.000',
    budgetMaks: 'Rp 53.000.000',
    efisiensi: '15% Under Budget',
    roidDiproyeksi: '22% per siklus panen (6 bulan)',
    kasAktif: 'Rp 120.000.000',
    pendingPO: '2 PO pupuk senilai Rp 12.000.000 menunggu pencairan',
  },
  panen: {
    estimasiBuah: '2.4 Ton Cabai Merah (Blok A1+A2)',
    estimasiBulan: '15 hari lagi',
    hargaJual: 'Rp 25.000/kg (rata-rata pasar)',
    estimasiPendapatan: 'Rp 60.000.000',
    kondisiTanaman: '98% KTP Pohon status Sangat Sehat',
  },
  sdm: {
    totalPetani: '8 orang',
    presensiHariIni: '7 dari 8 hadir',
    kepalaMandor: 'Pak Joko Santoso',
    tugasHariIni: 'Pemupukan Blok B1 & Pengecekan Drainase A1',
  },
  investor: {
    statusInvestasi: 'ON-TRACK — Sangat Aman',
