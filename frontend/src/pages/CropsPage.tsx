      ...
      {isFormAllowed && (
        <div className="bg-white p-4 rounded-4 border shadow-sm space-y-3">
          <h4 className="font-weight-bold text-dark m-0 d-flex align-items-center gap-2" style={{ fontSize: 15 }}>
            <i className="ri-add-circle-line text-success"></i> Tambah Master Komoditas Baru
          </h4>
          <form onSubmit={handleSubmit} className="row g-3 pt-1">
            <div className="col-md-5">
              <input
                type="text"
                placeholder="Nama Komoditas (contoh: Kelapa Sawit Tenera)"
                value={name}
            ...
            <div className="col-md-4">
              <input
                type="number"
                placeholder="Estimasi Durasi Siklus (Hari)"
                value={cycleDays}
            ...
            <div className="col-md-3">
              <button type="submit" className="tmp-btn bg-success text-white font-weight-bold p-2.5 w-100 rounded-3 border-0 shadow-xs" style={{ fontSize: 13 }}>
                <i className="ri-save-line me-1"></i> Simpan SOP Komoditas
              </button>
            </div>
          </form>
        </div>
