...
const OFFICIAL_ACCOUNTS: UserAccount[] = [
  {
    ...
    role: 'INVESTOR',
    passwords: ['investor123', 'admin123'],
  },
  {
  ...
  },
  {
    ...
    role: 'DIREKTUR',
    passwords: ['admin123', 'direktur123'],
  },
  {
