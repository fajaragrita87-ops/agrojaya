...
const initialPlantScans: PlantScanRecord[] = [
  ...
  },
  {
    ...
    healthScore: '96.2%',
    detectedIssue: 'Defisiensi Magnesium Ringan (<2% bercak kuning)',
    recommendation: 'Semprotkan pupuk mikro MgSO4 + Boron 2 gr/Liter air besok pagi.',
    brixEst: 'Glukomanan 46%',
